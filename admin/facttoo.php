...
while($row=mysqli_fetch_array($res)){
	...
	$output []=array('name'=>$row['name'],'join_data'=>$row['joining_date'],'designation'=>$row['designation'],'department'=>$row['department'],'mobile'=>$row['mobile'],'mail'=>$row['mail'],'userid'=>$row['userid']);
}
